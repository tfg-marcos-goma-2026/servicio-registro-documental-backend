 ...
 * @description Implementación simulada de IBlockchainPort para entornos de
...
@Injectable()
export class MockBlockchainService implements IBlockchainPort, OnModuleInit {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  verificarHash(_hash?: string): Promise<DocumentVerificationData> {
